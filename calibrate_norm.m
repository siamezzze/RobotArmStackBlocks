function M = calibrate_norm( p2, p3 )
    ...
    for i = 1:n
        A(2 * i - 1, :) = [p3(1,i) p3(2,i) p3(3,i) 1 0 0 0 0 -p2(1,i)*p3(1,i) -p2(1,i)*p3(2,i) -p2(1,i)*p3(3,i) -p2(1,i)];
        A(2 * i, :) = [0 0 0 0 p3(1,i) p3(2,i) p3(3,i) 1 -p2(2,i)*p3(1,i) -p2(2,i)*p3(2,i) -p2(2,i)*p3(3,i) -p2(2,i)];
    end
    [U, D, V] = svd(A);
    m = V(:, 12);
    Mt = reshape(m, [4, 3])';
